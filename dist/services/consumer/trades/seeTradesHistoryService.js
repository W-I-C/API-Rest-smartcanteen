...
class SeeTradesHistoryService {
    ...
    execute(uId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const verifyUser = yield selectTicket.query('SELECT ticketid,isconfirmed,proposaldate,confirmationdate,receptordecision,isdeleted from ticketTrade WHERE uId=$1', [uId]);
