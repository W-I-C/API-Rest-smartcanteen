...
export class SeeMealsCartService {
    ...
    async execute(uId: string) {
        ...
        const queryUser = await seeMealsCartDBClient.query(`SELECT meals.mealid, meals.name,cartmeals.cartmealid, meals.price, cartmeals.amount, meals.price*cartmeals.amount as mealtotal, 
